...
stateDiagram-v2
    ...
    pylon_0_e_arm          : set_e_arm(expand = 180.0)
    ...
    pylon_0_box_arm_height --> pylon_0_e_arm
    ...
    pylon_0_e_arm          --> e_0_pylon_height_init
