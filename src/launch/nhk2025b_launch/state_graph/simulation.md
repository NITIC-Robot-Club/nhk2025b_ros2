...
stateDiagram-v2
    ...
    pylon_0_position_get   : set_position(3.0, 1.15, 0.0)
    pylon_0_position_drop  : set_position(5.0, 1.15, 0.0)
    ...
    e_01_pylon_height_init : set_pylon_arm_height(right = 0.12, left = 0.12)
    ...
    e_01_position_get      : set_position(8.78, 4.65, 90.0)
    e_01_pylon_expand_get  : set_pylon_arm_expand(right = 20, left = 20)
    ...
    e_01_pylon_height_hold : set_pylon_arm_height(right = 0.07, left = 0.07)
    ...
    e_01_position_hold     : set_position(8.78, 3.0, 90.0)
    ...
    e_0_position_drop     : set_position(4.0, 3.0, 90.0)
    ...
    e_0_conveyor_drop     --> e_1_position_drop
    ...
    e_1_conveyor_drop        --> pylon_12_position_setup_0
