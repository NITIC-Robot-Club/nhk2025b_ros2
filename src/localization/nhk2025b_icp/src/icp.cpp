...
icp::icp (const rclcpp::NodeOptions& options) : Node ("icp", options) {
    ...
    lidar_sub_    = this->create_subscription<sensor_msgs::msg::LaserScan> (
        "/sensor/scan", rclcpp::SensorDataQoS (), std::bind (&icp::lidar_callback, this, std::placeholders::_1));
    map_sub_ =
        this->create_subscription<nav_msgs::msg::OccupancyGrid> ("/behavior/map", 1, std::bind (&icp::map_callback, this, std::placeholders::_1));
    current_pose_sub_ = this->create_subscription<geometry_msgs::msg::PoseStamped> (
        "/localization/current_pose", 1, std::bind (&icp::current_pose_callback, this, std::placeholders::_1));
