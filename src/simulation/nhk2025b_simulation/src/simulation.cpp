...
namespace simulation {
    simulation::simulation(const rclcpp::NodeOptions & options)
        ...
        swerve_subscriber_ = this->create_subscription<nhk2025b_msgs::msg::Swerve>("/swerve_result", 10, std::bind(&simulation::swerve_callback, this, std::placeholders::_1));
