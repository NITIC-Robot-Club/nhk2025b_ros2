...
class BoxInitializer : public rclcpp::Node {
   public:
    BoxInitializer () : Node ("box_initializer") {
        ...
        timer_ = this->create_wall_timer (std::chrono::milliseconds (100), std::bind (&BoxInitializer::publish_boxes, this));
        ...
        for (int i = 1; i <= 5; ++i) {
            ...
            switch (i) {
                case 1:
                    box.pose.position.x = 9.0;
                    box.pose.position.y = 0.8;
                    box.pose.position.z = 0.0;
                    break;
                case 2:
                    box.pose.position.x = 9.0;
                    box.pose.position.y = 2.3;
                    box.pose.position.z = 0.0;
                    break;
                case 3:
                    box.pose.position.x = 9.5;
                    box.pose.position.y = 0.8;
                    box.pose.position.z = 0.0;
                    break;
                case 4:
                    ...
                    break;
                case 5:
                    box.pose.position.x = 10.3;
                    box.pose.position.y = 2.3;
                    box.pose.position.z = 0.0;
                    break;
                case 6:
                    box.pose.position.x = 10.1;
                    box.pose.position.y = 2.3;
                    box.pose.position.z = 0.0;
                    break;
                case 7:
                    box.pose.position.x = 8.6;
                    box.pose.position.y = 2.3;
                    box.pose.position.z = 0.0;
                    break;
                case 8:
                    box.pose.position.x = 8.8;
                    box.pose.position.y = 2.3;
                    box.pose.position.z = 0.0;
                    break;
                case 9:
        ...
        for (int i = 1; i <= 3; ++i) {
            ...
            switch (i) {
                case 1:
                    ...
                    box.pose.position.y = 5.225;
                    box.pose.position.z = 0.144;
                    break;
                case 2:
                ...
                case 4:
                    box.pose.position.x = 9.0;
                    box.pose.position.y = 1.8;
                    box.pose.position.z = 0.0;
                    break;
                case 5:
                    box.pose.position.x = 9.4;
                    box.pose.position.y = 2.3;
                    box.pose.position.z = 0.0;
                    break;
                case 6:
                    box.pose.position.x = 9.7;
                    box.pose.position.y = 2.3;
                    box.pose.position.z = 0.0;
                    break;
                case 7:
                    box.pose.position.x = 10.0;
                    box.pose.position.y = 1.1;
                    box.pose.position.z = 0.0;
                    break;
                case 8:
                    box.pose.position.x = 10.3;
